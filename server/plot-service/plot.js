...
const uri =
  "mongodb://root:%40odricjunmongoepzcVtEZ39ZvawlM251997%21@52.52.97.221:27017/?authSource=admin&readPreference=primary&appname=MongoDB%20Compass&ssl=false";
...
clientMongo.connect(function () {
  ...
  new Promise((fire) => {
    ...
    if (result.error) {
      ...
      getRidesMonthDetailedData(result, "2021", "7").then((data) => {
        logger.info(data);
      });
    }
  });
